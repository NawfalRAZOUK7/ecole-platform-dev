...
import type { ComplianceDashboardItem } from './compliance.types';
import { useComplianceDashboard } from './useCompliance';
  ...
  return (
    <div className="page">
      ...
      <div className="stats-grid">
        <StatCard label="compliance.curriculumCount" value={dashboardQuery.data?.curriculum_count ?? 0} icon="📚" />
        <StatCard label="compliance.totalObjectives" value={dashboardQuery.data?.total_objectives ?? 0} icon="🎯" />
        <StatCard label="compliance.mappedObjectives" value={dashboardQuery.data?.mapped_objectives ?? 0} icon="🔗" />
        <StatCard
