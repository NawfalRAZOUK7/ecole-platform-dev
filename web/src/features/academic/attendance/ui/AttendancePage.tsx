...
import type { ClassOption } from '@/features/lms/teacher/api/teacher.api';
import type { ColumnDef } from '@/shared/ui/DataTable';
import type { AttendanceRecord, AttendanceStatus } from '../model/attendance.types';
import { useClassAttendance, useMarkAttendance } from '../model/useAttendance';
...
export function AttendancePage() {
  ...
  function updateRecord(studentId: string, patch: Partial<AttendanceDraftRow>) {
    ...
    setRecords((current) =>
      current.map((record) => (record.student_id === studentId ? { ...record, ...patch } : record)),
    );
  }
