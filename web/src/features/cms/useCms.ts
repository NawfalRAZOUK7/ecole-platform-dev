...
export function useCreateCmsQuiz() {
  ...
  return useMutation({
    mutationFn: async (payload: Record<string, unknown>) => (await cmsService.createQuiz(payload)).data,
    onSuccess: async () => {
...
export function useUpdateCmsQuiz() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ quizId, payload }: { quizId: string; payload: Record<string, unknown> }) => {
...
export function useCreateCmsContent() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (payload: Record<string, unknown>) => (await cmsService.createContent(payload)).data,
    onSuccess: async () => {
...
export function useUpdateCmsContent() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({ contentId, payload }: { contentId: string; payload: Record<string, unknown> }) => {
