    ...
    <div className="page calendar-page">
      <div className="page-header page-header--split">
        ...
        <div className="page-actions">
          ...
          {options.ical_url && (
            <a href={options.ical_url} download="calendar.ics" className="btn btn-secondary">
      ...
      <div className="calendar-layout">
        ...
        <CalendarGrid
          ...
          selectedDate={selectedDate}
          view={view}
          onChangeAnchorDate={(direction) =>
            setAnchorDate((current) => shiftAnchorDate(view, current, direction))
          }
          onOpenDetails={setDetailSeedEvent}
      ...
      {detailEvent && (
        <div className="modal-overlay" onClick={() => setDetailSeedEvent(null)}>
          ...
          >
            {detailSeedEvent?.source === 'event' && detailQuery.isLoading && !detailQuery.data ? (
              <LoadingState />
            ) : (
              <EventDetail
                event={detailEvent}
