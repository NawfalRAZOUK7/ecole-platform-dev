...
import { ROLE_OPTIONS, type EventFormProps } from '../model/calendar.types';
import type { EventFormState } from '../model/types';
      ...
      <div className="modal-card calendar-modal-card" onClick={(event) => event.stopPropagation()}>
        ...
        <label className="form-field">
          ...
          <input
            value={form.title_fr}
            onChange={(event) =>
              setForm((current) => ({ ...current, title_fr: event.target.value }))
            }
          />
        </label>
        ...
        <div className="calendar-form-grid">
          <label className="form-checkbox">
            <input
              ...
              onChange={(event) =>
                setForm((current) => ({ ...current, is_all_day: event.target.checked }))
              }
            />
          ...
          <label className="form-field">
            ...
            <select
              ...
              onChange={(event) =>
                setForm((current) => ({
                  ...current,
                  recurrence_frequency: event.target
                    .value as EventFormState['recurrence_frequency'],
                }))
              }
            >
          ...
          <div className="calendar-form-grid">
            ...
            <label className="form-field">
              ...
              <input
                ...
                onChange={(event) =>
                  setForm((current) => ({ ...current, recurrence_until: event.target.value }))
                }
              />
            </label>
          </div>
