...
import type { Message, ReadReceipt } from '../api/messages.api';
...
export function ChatPage() {
  ...
  const dismissibleError = useDismissibleError(
    toBannerError(
      messagesQuery.error ?? sendMessageMutation.error ?? markReadMutation.error,
      t('app.error'),
    ),
  );
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
        ...
        <h1 className="page-title" style={{ marginBottom: 0, fontSize: 20 }}>
          {t('messages.chat')}
        </h1>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="chat-bubble-meta">
                  <span>
                    {formatDate(message.sent_at, i18n.language, {
                      hour: '2-digit',
                      minute: '2-digit',
                    })}
                  </span>
