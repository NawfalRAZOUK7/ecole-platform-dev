...
import { useImportFromQuiz } from '../model/useQuestionBank';
import type { DifficultyLevel, Question, QuestionType } from '../model/question-bank.types';
      ...
      {summary && (
        <div style={{ display: 'flex', gap: 12, marginBottom: 16 }}>
          <Badge variant="success">
            {t('questionBank.import.imported', { count: summary.imported })}
          </Badge>
          {summary.skipped > 0 && (
            <Badge variant="warning">
              {t('questionBank.import.skipped', { count: summary.skipped })}
            </Badge>
          )}
        </div>
      )}
      ...
      {preview && preview.length > 0 && (
        <>
          <h2 style={{ marginBottom: 12, fontSize: 16 }}>
            {t('questionBank.import.previewTitle')}
          </h2>
