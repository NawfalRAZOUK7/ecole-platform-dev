...
import type { AssessmentItem } from '@/features/lms/teacher/api/teacher.api';
      ...
      () =>
        toBannerError(
          classesQuery.error ??
            ...
            publishAssessmentMutation.error,
          t('app.error'),
        ),
      [
        assessmentsQuery.error,
          ...
          {assessmentsQuery.hasNextPage && (
            <div style={{ textAlign: 'center', marginTop: 16 }}>
              <button
                ...
                onClick={() => void assessmentsQuery.fetchNextPage()}
                disabled={assessmentsQuery.isFetchingNextPage}
              >
