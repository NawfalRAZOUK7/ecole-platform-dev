...
import type { AssignmentItem, CourseItem } from '@/features/lms/teacher/api/teacher.api';
...
export function AssignmentFormPage() {
  ...
  const dismissibleError = useDismissibleError(
    useMemo(
      () =>
        toBannerError(
          coursesQuery.error ?? assignmentsQuery.error ?? createAssignmentMutation.error,
          t('app.error'),
        ),
