...
import { quizzesService } from '../api/quizzes.api';

export const quizzesQueryKeys = {
  all: ['quizzes'] as const,
  detail: (quizId: string | null | undefined) =>
    [...quizzesQueryKeys.all, 'detail', quizId] as const,
  analytics: (quizId: string | null | undefined) =>
    [...quizzesQueryKeys.all, 'analytics', quizId] as const,
  results: (attemptId: string | null | undefined) =>
    [...quizzesQueryKeys.all, 'results', attemptId] as const,
};
