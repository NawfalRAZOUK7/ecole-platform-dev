...
import type { BudgetEnvelope } from './budgets.types';
import { useBudgets, useCreateBudget, useDeleteBudget } from './useBudgets';
...
export function BudgetListPage() {
  ...
  return (
    <div className="page budgets-page">
      ...
      <ErrorBanner error={toBannerError(budgetsQuery.error ?? createBudgetMutation.error ?? deleteBudgetMutation.error, t('app.error'))} />
      ...
      <div className="filters-bar">
        ...
        <input type="date" className="filter-input" value={from} onChange={(event) => setFrom(event.target.value)} />
        <input type="date" className="filter-input" value={to} onChange={(event) => setTo(event.target.value)} />
      </div>

      {showCreateForm && (
        <FormProvider {...methods}>
          <form className="card budgets-page__form" onSubmit={methods.handleSubmit(handleCreateBudget)}>
            <FormField<BudgetFormValues> name="name" label="budgets.name" />
            <FormField<BudgetFormValues> name="total_amount" label="budgets.totalAmount" type="number" />
            ...
            <button type="submit" className="btn btn-primary" disabled={createBudgetMutation.isPending}>
