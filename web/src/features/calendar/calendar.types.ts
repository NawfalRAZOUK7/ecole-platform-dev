import type { CalendarClassOption, CalendarEventItem, CalendarView, EventFormState, EventRsvpStatus, EventType } from './types';

export const ROLE_OPTIONS = ['ADM', 'DIR', 'TCH', 'PAR', 'STD'] as const;
