...
import type { SecuritySettingsProps } from '../model/profile.types';
...
export function SecuritySettings({
  ...
  return (
    <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: 16, marginTop: 16 }}>
      {!showPasswordForm ? (
        <button className="btn btn-secondary" onClick={() => onToggle(true)}>
          ...
          <form onSubmit={onSubmit}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                ...
                disabled={
                  isPending || !currentPassword || !newPassword || newPassword !== confirmPassword
                }
              >
