...
import { useLateFeePolicy, useUpdateLateFeePolicy } from '../model/useBilling';
...
export function LateFeePolicyPage() {
  ...
  const {
    ...
    watch,
    formState: { errors },
  } = useForm<LateFeePolicyFormValues>({
      ...
      <div className="card" style={{ maxWidth: 560 }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-field">
            ...
            {errors.fee_percent && <span className="form-error">{errors.fee_percent.message}</span>}
          </div>
          ...
          <div className="form-field">
            ...
            />
            {errors.max_fee_cap && <span className="form-error">{errors.max_fee_cap.message}</span>}
