...
import { useBudgetAnalytics } from '../model/useBudgets';
  ...
  return (
    <div className="page budgets-analytics-page">
      ...
      <div className="gradebook-page__stats">
        <StatCard
          label="budgets.totalBudget"
          value={madFormatter.format(analyticsQuery.data?.total_budget ?? 0)}
        />
        <StatCard
          label="budgets.totalSpent"
          value={madFormatter.format(analyticsQuery.data?.total_spent ?? 0)}
        />
        <StatCard
          label="budgets.remaining"
          value={madFormatter.format(analyticsQuery.data?.remaining ?? 0)}
        />
