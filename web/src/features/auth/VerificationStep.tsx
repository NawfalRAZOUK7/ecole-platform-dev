...
import type { VerificationStepProps } from './register.types';
  ...
  return (
    <form onSubmit={onSubmit} className="login-form">
      ...
      <button
        type="button"
        onClick={onSkip}
        style={{ width: '100%', marginTop: 8, background: 'none', border: 'none', color: 'var(--color-text-secondary)', cursor: 'pointer', fontSize: 13 }}
      >
        {t('register.skipOtp')}
      </button>
    </form>
