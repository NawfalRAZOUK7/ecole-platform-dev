...
import type { SchoolInfoStepProps } from '../model/auth.types';
      ...
      <div>
        ...
        <label className="form-field" htmlFor="reg-dob">
          ...
          <input
            ...
            type="date"
            value={dateOfBirth}
            onChange={(event) => onChangeDateOfBirth(event.target.value)}
            disabled={loading}
          />
        </label>
        <label className="form-field" htmlFor="reg-class">
          ...
          <input
            ...
            type="text"
            value={classLevel}
            onChange={(event) => onChangeClassLevel(event.target.value)}
            disabled={loading}
            maxLength={50}
          />
        </label>
        <label className="form-field" htmlFor="reg-relation">
          ...
          <select
            ...
            onChange={(event) => onChangeRelationshipType(event.target.value)}
            disabled={loading}
        ...
        <label className="form-field" htmlFor="reg-subject">
          ...
          <input
            ...
            onChange={(event) => onChangeSubjectSpecialty(event.target.value)}
            disabled={loading}
            maxLength={200}
          />
        </label>
        <label className="form-field" htmlFor="reg-qual">
          ...
          <input
            ...
            type="text"
            value={qualification}
            onChange={(event) => onChangeQualification(event.target.value)}
            disabled={loading}
            maxLength={200}
          />
        </label>
