...
import type { RegisterStep } from '../model/auth.types';
import { useConsumeInvite, useRegister, useVerifyEmail } from '../model/useAuthQuery';
    ...
    try {
      ...
      if (inviteToken) {
        try {
          ...
          setError(
            inviteError instanceof Error ? inviteError.message : t('register.inviteConsumeFailed'),
          );
        }
      }
