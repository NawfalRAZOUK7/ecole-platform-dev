...
import { useDocumentPreview } from './useDocuments';
import { isImage, isPdf, openSignedUrl } from './documents.utils';
      ...
      <div className="card" style={{ minHeight: 400 }}>
        {!info ? (
          ...
          <iframe
            src={info.preview_url}
            title={info.original_filename}
            style={{ width: '100%', height: '70vh', border: 'none', borderRadius: 8, fontFamily: 'monospace' }}
          />
        ) : (
          <div style={{ padding: 32, textAlign: 'center' }}>
            <div style={{ fontSize: 48, marginBottom: 12 }}>📄</div>
