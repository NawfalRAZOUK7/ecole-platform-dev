...
import { resultsService, type ResultsFilters } from './results.service';

export const resultsQueryKeys = {
  all: ['results'] as const,
  assignments: (filters: Omit<ResultsFilters, 'cursor'>) => [...resultsQueryKeys.all, 'assignments', filters] as const,
