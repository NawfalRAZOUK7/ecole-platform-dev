...
import type { ContentLibraryTab } from './content-library.types';
    ...
    <div className="page">
      ...
      <div className="filters-bar" style={{ marginBottom: 16 }}>
        {(['browse', 'upload', 'submissions'] as ContentLibraryTab[]).map((tabKey) => (
          <button key={tabKey} className={`btn ${tab === tabKey ? 'btn-primary' : 'btn-secondary'}`} onClick={() => setTab(tabKey)} style={{ marginRight: 8 }}>
