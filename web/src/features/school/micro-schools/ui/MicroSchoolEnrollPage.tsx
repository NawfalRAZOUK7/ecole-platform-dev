...
import { useCreateMicroPayment, useEnrollMicroStudent } from '../model/useMicroSchools';
...
export function MicroSchoolEnrollPage() {
  ...
  return (
    <div className="page micro-school-enroll-page">
      ...
      <ErrorBanner
        error={toBannerError(enrollMutation.error ?? createPaymentMutation.error, t('app.error'))}
      />
      ...
      <FormProvider {...methods}>
        ...
        >
          ...
          <FormField<EnrollFormValues>
            name="payment_amount"
            label="microSchools.amount"
            type="number"
          />
          <FormSelect<EnrollFormValues>
            name="payment_status"
          ...
          <button
            ...
            disabled={enrollMutation.isPending || createPaymentMutation.isPending}
          >
            {enrollMutation.isPending || createPaymentMutation.isPending
              ? t('app.loading')
