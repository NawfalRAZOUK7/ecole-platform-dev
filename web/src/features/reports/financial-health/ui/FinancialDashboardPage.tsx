    ...
    return [
      {
        ...
        amount: cashflow.expected_income,
        fill: 'var(--color-success)',
      },
      {
        label: t('financialHealth.expenses'),
        amount: -cashflow.expected_expenses,
    ...
    <div className="page">
      ...
      <div className="stats-grid">
        ...
        <StatCard
          ...
          value={
            academicYearId
              ? formatCurrency(costQuery.data?.cost_per_student ?? 0)
              : t('financialHealth.awaitingAcademicYear')
          }
          icon="🎓"
        />
        <StatCard
      ...
      {latestSnapshot ? (
        <div className="card">
          ...
          <p>
            {formatDate(latestSnapshot.snapshot_date, i18n.language)} ·{' '}
            {t('financialHealth.collectionRate')}: {latestSnapshot.collection_rate.toFixed(1)}%
          </p>
          <p>
            {t('financialHealth.totalReceivable')}:{' '}
            {formatCurrency(latestSnapshot.total_receivable)} ·{' '}
