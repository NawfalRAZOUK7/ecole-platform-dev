...
import type { FinancialSnapshot } from './financial-health.types';
import { useFinancialTrends } from './useFinancialHealth';

type SnapshotRow = FinancialSnapshot & Record<string, unknown>;

function downloadSnapshotCsv(snapshot: FinancialSnapshot) {
  const rows = [
    ['snapshot_date', 'collection_rate', 'total_receivable', 'total_collected', 'overdue_amount', 'overdue_count', 'avg_payment_delay_days'],
    [
