...
import type { Justification } from '@/features/admin/api/admin.api';
          ...
          {items.map((item) => (
            <div key={item.id} className="card">
              ...
              >
                ...
                >
                  {t(
                    `admin.justifications.status${item.status.charAt(0).toUpperCase() + item.status.slice(1)}`,
                    item.status,
                  )}
                </span>
