...
import { useAdminBatchRegister } from '@/features/admin/model/useAdmin';
import type { BatchResult, CsvRow } from '@/features/admin/api/admin.api';
  ...
  return (
    <div className="page">
      ...
      <div className="card" style={{ marginBottom: 16 }}>
        ...
        {fileName && (
          <span style={{ fontSize: 13, color: 'var(--color-text-secondary)' }}>{fileName}</span>
        )}
      </div>
            ...
            <div>
              ...
              {result.errors.map((item, index) => (
                <div
                  ...
                  style={{ fontSize: 13, color: 'var(--color-danger)', marginBottom: 4 }}
                >
