...
import type { UserItem } from '@/features/admin/api/admin.api';
                ...
                {items.map((item) => (
                  <tr key={item.id}>
                    <td>
                      {item.full_name}
                      {item.totp_enabled && (
                        <span title="2FA" style={{ marginInlineStart: 4 }}>
                          🔐
                        </span>
                      )}
                    </td>
                    <td>
                      {item.email}
                      {item.email_verified && (
                        <span title="Verified" style={{ marginInlineStart: 4 }}>
                          ✓
                        </span>
                      )}
                    </td>
                    ...
                    <td>
                      ...
                      >
                        {t(
                          `admin.users.status${item.status.charAt(0).toUpperCase() + item.status.slice(1)}`,
                          item.status,
                        )}
                      </span>
                    </td>
