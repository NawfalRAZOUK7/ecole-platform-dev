...
import { complianceService } from '../api/compliance.api';
import type { ComplianceReport } from '../model/compliance.types';
import {
  useComplianceReport,
    ...
    <div className="page">
      ...
      {reportDetailQuery.data ? (
        <div className="card">
          ...
          <p>
            {reportDetailQuery.data.curriculum_subject} · {reportDetailQuery.data.curriculum_grade}
          </p>
          <p>
            {t('compliance.compliancePercent')}: {reportDetailQuery.data.compliance_percent}%
          </p>
          <p>
            {t('compliance.unmappedObjectives')}:{' '}
            {reportDetailQuery.data.unmapped_objectives.join(', ') || '-'}
          </p>
        </div>
      ) : null}
    </div>
