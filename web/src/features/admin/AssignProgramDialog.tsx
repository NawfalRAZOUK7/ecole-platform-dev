...
import { useAssignProgramMutation, useProgramsQuery, useProgramVersionsQuery } from './usePrograms';
import type { Program, ProgramAssignmentReason } from './programs.service';
