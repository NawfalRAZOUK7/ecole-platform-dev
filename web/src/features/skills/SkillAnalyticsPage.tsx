...
import type { SkillLeaderboardEntry } from './skills.types';
import { useClassSkillAnalytics, useSchoolSkillAnalytics, useSkillLeaderboard } from './useSkills';
...
export function SkillAnalyticsPage() {
  ...
  const comparisonData = useMemo(
    ...
    [classAnalyticsQuery.data?.average_overall_score, schoolAnalyticsQuery.data?.average_overall_score, t]
  );
                ...
                <div className="card" style={{ minHeight: 360 }}>
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <BarChart data={comparisonData}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Bar dataKey="classValue" fill="var(--color-primary)" name={t('skills.classAverage')} />
                      <Bar dataKey="schoolValue" fill="var(--color-success)" name={t('skills.schoolAverage')} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
                <div className="card" style={{ minHeight: 360 }}>
