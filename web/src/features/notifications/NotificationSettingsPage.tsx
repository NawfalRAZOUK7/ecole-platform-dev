...
import type { DeviceItem, NotificationPreference } from './types';
...
export function NotificationSettingsPage() {
  ...
  const [preferences, setPreferences] = useState<NotificationPreference[]>(() => preferencesQuery.data ?? []);
  const [digestFrequency, setDigestFrequency] = useState(() => digestQuery.data?.digest_frequency ?? 'off');
  ...
  return (
    <div className="page">
      ...
      <ErrorBanner
        ...
        onRetry={loadError ? () => void Promise.all([
