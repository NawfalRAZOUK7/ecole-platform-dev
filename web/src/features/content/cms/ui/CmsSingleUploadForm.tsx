...
import { ACCEPT_MAP, CONTENT_TYPES, LEVELS, SUBJECTS } from '../model/content-upload.types';
    ...
    <form onSubmit={onSubmit} className="card" style={{ padding: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        <div className="form-field">
          ...
          <select
            required
            value={contentType}
            onChange={(event) => onChangeContentType(event.target.value)}
          >
      ...
      <div className="form-field">
        ...
        <input
          ...
          onChange={(event) => onChangeMainFile(event.target.files?.[0] || null)}
        />
      ...
      <div className="form-field">
        ...
        <input
          type="file"
          accept="image/*"
          onChange={(event) => onChangeThumbnailFile(event.target.files?.[0] || null)}
        />
