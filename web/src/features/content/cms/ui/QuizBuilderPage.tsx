...
import {
  ...
  type Question,
  type QuestionType,
} from '../model/quiz-builder.types';
import { useCmsQuiz, useCreateCmsQuiz, usePublishCmsQuiz, useUpdateCmsQuiz } from '../model/useCms';
  ...
  return (
    <div className="page">
      <QuizBuilderForm
        ...
        title={title}
        onAddQuestion={(type) =>
          setQuestions((current) => [...current, defaultQuestion(type, current.length)])
        }
        onBack={() => {
