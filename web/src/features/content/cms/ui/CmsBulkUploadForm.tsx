...
import { LEVELS, SUBJECTS, type BulkUploadResult } from '../model/content-upload.types';
    ...
    <div className="card" style={{ padding: 24 }}>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 16 }}>
        <select
          ...
          value={levelBand}
          onChange={(event) => onChangeLevelBand(event.target.value)}
        >
      ...
      <input
        type="file"
        multiple
        onChange={(event) => onChangeBulkFiles(Array.from(event.target.files || []))}
