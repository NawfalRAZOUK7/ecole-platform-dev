...
import { LEVEL_OPTIONS, SUBJECT_OPTIONS } from '../model/content-library.types';
import { useUploadContentItem } from '@/features/lms/teacher/model/useTeacher';
    ...
    <>
      ...
      {success ? (
        <div className="card" style={{ padding: 20, maxWidth: 500 }}>
          <h3 style={{ color: 'var(--color-success)', marginBottom: 12 }}>
            {t('teacherContent.uploadSuccess')}
          </h3>
        ...
        >
          ...
          <label className="form-field" style={{ marginBottom: 12 }}>
            <span>{t('teacherContent.contentTitle')}</span>
            <input
          ...
          <label className="form-field" style={{ marginBottom: 12 }}>
            <span>{t('teacherContent.description')}</span>
            <input
              className="filter-input"
              value={description}
          ...
          <label className="form-field" style={{ marginBottom: 12 }}>
            ...
            >
              ...
              <option value="story">{t('cms.contentTypes.story')}</option>
              <option value="coloring_book">{t('cms.contentTypes.coloring_book')}</option>
            </select>
          </label>
          <label className="form-field" style={{ marginBottom: 12 }}>
          ...
          <label className="form-field" style={{ marginBottom: 12 }}>
            <span>{t('teacherContent.file')}</span>
            <input
              type="file"
