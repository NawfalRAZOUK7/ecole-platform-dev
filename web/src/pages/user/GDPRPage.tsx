...
import { gdprService, type CurrentConsentEntry } from '@/features/user/privacy/api/gdpr.api';
  ...
  return (
    <div className="page">
      ...
      <ErrorBanner
        error={
          pageError ??
          (consentLogQuery.error instanceof Error ? consentLogQuery.error.message : null)
        }
            ...
            {recentHistory.map((entry) => (
              <div key={entry.id} className="card" style={{ padding: 16 }}>
                ...
                >
                  ...
                  <Badge variant={entry.outcome === 'success' ? 'success' : 'warning'}>
                    {entry.outcome}
                  </Badge>
                </div>
