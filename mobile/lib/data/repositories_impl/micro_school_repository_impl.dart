...
class MicroSchoolRepositoryImpl implements MicroSchoolRepository {
  ...
  Future<void> deleteMicroSchool(String id) async {
    await _api.put('/micro/schools/$id', body: {
      'status': 'closed',
      'id': id,
    });
  }
  ...
  Future<MicroEnrollment> enrollStudent(
    ...
    final response = await _api.post('/micro/enrollments', body: {
  ...
  Future<MicroPayment> createPayment(
    ...
    final response = await _api.post('/micro/payments', body: {
      'micro_school_id': id,
      'parent_id': '00000000-0000-0000-0000-000000000000',
  ...
  Future<MicroResource> addResource(
    ...
    final response = await _api.post('/micro/resources', body: {
      'micro_school_id': id,
      'title': payload['title'],
  ...
  Future<Map<String, dynamic>> createGroup(
    ...
    final response = await _api.post('/micro/groups', body: {
      'micro_school_id': id,
      'name': payload['name'],
