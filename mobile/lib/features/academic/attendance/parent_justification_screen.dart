...
import 'package:ecole_platform/features/academic/attendance/justification_provider.dart';
      ...
      body: async.when(
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            onRefresh: () => ref.read(justificationProvider.notifier).refresh(),
            child: ListView(
      ...
      children: <Widget>[
        ListTile(
          ...
          subtitle: widget.absence.justificationStatus == 'pending'
              ? Text(
                  t.t('justification.alreadyPending'),
