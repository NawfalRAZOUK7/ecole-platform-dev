...
**By API domain:**
```bash
pytest tests/integration/api/auth/          -v   # Auth flows, RBAC
pytest tests/integration/api/user/          -v   # Profiles, family
...
pytest tests/integration/api/ai/            -v   # Games, rewards
pytest tests/integration/api/content/       -v   # Documents, signed uploads
pytest tests/integration/api/admin/         -v   # Compliance, calendar events
pytest tests/integration/api/reports/       -v   # Reports and analytics
pytest tests/integration/api/operations/    -v   # Readiness, filters, websocket
```
...
Location: `system-tests/postman/`

### 4.1 Full Smoke Collection

```bash
newman run system-tests/postman/ecole_platform_full.postman_collection.json \
...
```bash
# Academic lifecycle
newman run system-tests/postman/scenario_academic_year_lifecycle.postman_collection.json -e system-tests/postman/env_local.json

# Student journey
newman run system-tests/postman/scenario_student_lifecycle.postman_collection.json -e system-tests/postman/env_local.json

# Teacher workflow
newman run system-tests/postman/scenario_teacher_workflow.postman_collection.json -e system-tests/postman/env_local.json

# Parent journey
newman run system-tests/postman/scenario_parent_journey.postman_collection.json -e system-tests/postman/env_local.json

# Admin operations
newman run system-tests/postman/scenario_admin_operations.postman_collection.json -e system-tests/postman/env_local.json

# Billing cycle
newman run system-tests/postman/scenario_billing_cycle.postman_collection.json -e system-tests/postman/env_local.json

# Quiz assessment
newman run system-tests/postman/scenario_quiz_assessment_flow.postman_collection.json -e system-tests/postman/env_local.json

# Content management
newman run system-tests/postman/scenario_content_management.postman_collection.json -e system-tests/postman/env_local.json

# RBAC / ABAC / Security
newman run system-tests/postman/scenario_rbac_matrix.postman_collection.json -e system-tests/postman/env_local.json
newman run system-tests/postman/scenario_abac_policies.postman_collection.json -e system-tests/postman/env_local.json
newman run system-tests/postman/scenario_security_hardening.postman_collection.json -e system-tests/postman/env_local.json

# Upload / Download
newman run system-tests/postman/scenario_direct_upload_flow.postman_collection.json -e system-tests/postman/env_local.json

# Invoice PDF
newman run system-tests/postman/scenario_invoice_pdf_flow.postman_collection.json -e system-tests/postman/env_local.json

# Program enrollment
newman run system-tests/postman/scenario_program_enrollment_flow.postman_collection.json -e system-tests/postman/env_local.json
```
...
k6 run system-tests/load/baseline/03_file_uploads.js
k6 run system-tests/load/baseline/04_websocket.js
```
...
k6 run system-tests/load/stress/upload_burst.js
```
...
cd backend
pytest tests/unit/ -q
pytest tests/integration/api/auth/ -q
...
| Infrastructure config | `system-tests/load/smoke/`, Postman smoke |
